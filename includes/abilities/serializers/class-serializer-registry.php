...
class Serializer_Registry {
	...
	private const SERIALIZERS = array(
		...
		'designsetgo/text-path' => Text_Path_Serializer::class,
		'designsetgo/comparison-table' => Comparison_Table_Serializer::class,
		'designsetgo/timeline-item' => Timeline_Item_Serializer::class,
		'designsetgo/hotspot-item' => Hotspot_Item_Serializer::class,
		'designsetgo/advanced-heading' => Advanced_Heading_Serializer::class,
		'designsetgo/blobs' => Blobs_Serializer::class,
		'designsetgo/heading-segment' => Heading_Segment_Serializer::class,
		...
		'designsetgo/query-no-results' => Query_No_Results_Serializer::class,
		'designsetgo/scroll-slide' => Scroll_Slide_Serializer::class,
		'designsetgo/scroll-slides' => Scroll_Slides_Serializer::class,
		'designsetgo/sticky-sections' => Sticky_Sections_Serializer::class,
		'designsetgo/section-divider' => Section_Divider_Serializer::class,
		'designsetgo/fifty-fifty' => Fifty_Fifty_Serializer::class,
		'designsetgo/row' => Row_Serializer::class,
		'designsetgo/grid' => Grid_Serializer::class,
		'designsetgo/counter-group' => Counter_Group_Serializer::class,
		'designsetgo/counter' => Counter_Serializer::class,
		'designsetgo/flip-card' => Flip_Card_Serializer::class,
		'designsetgo/flip-card-face' => Flip_Card_Face_Serializer::class,
		'designsetgo/flip-card-front' => Flip_Card_Front_Serializer::class,
		'designsetgo/flip-card-back' => Flip_Card_Back_Serializer::class,
		'designsetgo/icon' => Icon_Serializer::class,
		'designsetgo/accordion' => Accordion_Serializer::class,
		'designsetgo/accordion-item' => Accordion_Item_Serializer::class,
		'designsetgo/divider' => Divider_Serializer::class,
		'designsetgo/countdown-timer' => Countdown_Timer_Serializer::class,
		'designsetgo/progress-bar' => Progress_Bar_Serializer::class,
		'designsetgo/pill' => Pill_Serializer::class,
		'designsetgo/map' => Map_Serializer::class,
		'designsetgo/card' => Card_Serializer::class,
		'designsetgo/icon-list' => Icon_List_Serializer::class,
		'designsetgo/icon-list-item' => Icon_List_Item_Serializer::class,
		'designsetgo/icon-button' => Icon_Button_Serializer::class,
		'designsetgo/modal' => Modal_Serializer::class,
		'designsetgo/modal-trigger' => Modal_Trigger_Serializer::class,
		'designsetgo/table-of-contents' => Table_Of_Contents_Serializer::class,
		'designsetgo/image-accordion' => Image_Accordion_Serializer::class,
		'designsetgo/image-accordion-item' => Image_Accordion_Item_Serializer::class,
		'designsetgo/scroll-accordion' => Scroll_Accordion_Serializer::class,
		'designsetgo/scroll-accordion-item' => Scroll_Accordion_Item_Serializer::class,
		'designsetgo/slider' => Slider_Serializer::class,
		'designsetgo/slide' => Slide_Serializer::class,
		'designsetgo/scroll-marquee' => Scroll_Marquee_Serializer::class,
		'designsetgo/tabs' => Tabs_Serializer::class,
		'designsetgo/tab' => Tab_Serializer::class,
		'designsetgo/form-builder' => Form_Builder_Serializer::class,
	);
