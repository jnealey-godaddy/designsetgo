/**
 * Form Date Field Block - Deprecated Versions
 *
 * vStatic reproduces the last STATIC save (the block is now server-rendered via
 * render.php; save() returns null). isEligible matches any stored static date
...
const vStatic = {
	...
	isEligible(attributes, innerBlocks, { innerHTML }) {
		...
		return (
			Boolean(innerHTML) && innerHTML.includes('dsgo-form-field--date')
		);
	},
