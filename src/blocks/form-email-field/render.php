<?php
/**
 * Form Email Field - server-side render.
 *
...
if ( ! function_exists( 'designsetgo_render_form_email_field' ) ) {
	/**
	 * Render the Form Email Field block.
	 *
	 * @param array    $attributes Block attributes.
	 ...
	 * @return void
	 */
	function designsetgo_render_form_email_field( $attributes, $content, $block ) {
		...
		$input = '<input type="email" id="' . esc_attr( $field_id ) . '" name="' . esc_attr( $field_name ) . '" class="dsgo-form-field__input"';
		if ( '' !== $placeholder ) {
		...
		$wrapper = get_block_wrapper_attributes(
			array(
				'class' => 'dsgo-form-field dsgo-form-field--email',
...
designsetgo_render_form_email_field( $attributes, $content, $block );
