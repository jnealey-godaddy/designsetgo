 ...
 *
 * Canonical home for this probe: engine source (this file) and test helpers
 * (`tests/unit/helpers/non-default-value.js`, a re-export) both need it, and
 * engine source must never import from `tests/` — so it lives here and the
 * test helper points back at it, not the other way around.
 *
