...
<!-- wp:designsetgo/image-accordion-item {"uniqueId":"acc-2","className":"dsgo-image-accordion__item","style":{"background":{"backgroundImage":{"url":"{{dsgo:placeholder-landscape}}"}}}} -->
...
<!-- wp:designsetgo/image-accordion-item {"uniqueId":"acc-3","className":"dsgo-image-accordion__item","style":{"background":{"backgroundImage":{"url":"{{dsgo:placeholder-landscape}}"}}}} -->
...
<!-- wp:designsetgo/image-accordion-item {"uniqueId":"acc-4","className":"dsgo-image-accordion__item","style":{"background":{"backgroundImage":{"url":"{{dsgo:placeholder-landscape}}"}}}} -->
