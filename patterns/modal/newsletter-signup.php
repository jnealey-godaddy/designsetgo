...
<!-- wp:designsetgo/form-builder {"formId":"8ec8a00c","submitButtonAlignment":"center","successMessage":"Thank you for subscribing!","fieldSpacing":"1.5rem","inputHeight":"44px","inputPadding":"0.75rem","submitButtonPaddingVertical":"0.75rem","submitButtonPaddingHorizontal":"2rem","submitButtonHeight":"44px"} -->
<div class="wp-block-designsetgo-form-builder dsgo-form-builder dsgo-form-builder--align-center" style="--dsgo-form-field-spacing:1.5rem;--dsgo-form-input-height:44px;--dsgo-form-input-padding:0.75rem" data-form-id="8ec8a00c" data-ajax-submit="true" data-success-message="Thank you for subscribing!" data-error-message="There was an error submitting the form. Please try again."><form class="dsgo-form" method="post" novalidate><div class="dsgo-form__fields"><!-- wp:designsetgo/form-email-field {"fieldName":"email","label":"Email Address","placeholder":"your@email.com","required":true} -->
