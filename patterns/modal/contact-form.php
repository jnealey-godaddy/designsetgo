...
<!-- wp:designsetgo/form-builder {"formId":"b375c2c9","successMessage":"Thank you! Your message has been sent.","fieldSpacing":"1.5rem","inputHeight":"44px","inputPadding":"0.75rem","submitButtonPaddingVertical":"0.75rem","submitButtonPaddingHorizontal":"2rem","submitButtonHeight":"44px"} -->
<div class="wp-block-designsetgo-form-builder dsgo-form-builder dsgo-form-builder--align-left" style="--dsgo-form-field-spacing:1.5rem;--dsgo-form-input-height:44px;--dsgo-form-input-padding:0.75rem" data-form-id="b375c2c9" data-ajax-submit="true" data-success-message="Thank you! Your message has been sent." data-error-message="There was an error submitting the form. Please try again."><form class="dsgo-form" method="post" novalidate><div class="dsgo-form__fields"><!-- wp:designsetgo/form-text-field {"fieldName":"name","label":"Name","placeholder":"Your name","required":true} -->
