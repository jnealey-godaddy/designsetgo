...
<div class="wp-block-designsetgo-section alignfull dsgo-stack dsgo-no-width-constraint" style="border-radius:16px;min-height:350px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><div class="dsgo-stack__inner"><!-- wp:designsetgo/icon-button {"text":"Play","url":"#video-testimonial-modal","icon":"play","iconGap":"8px"} -->
