...
<div class="wp-block-designsetgo-grid alignfull dsgo-grid dsgo-grid-cols-2 dsgo-grid-cols-tablet-1 dsgo-grid-cols-mobile-1 dsgo-no-width-constraint" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><div class="dsgo-grid__inner" style="display:grid;grid-template-columns:repeat(2, 1fr);align-items:center;row-gap:var(--wp--preset--spacing--60);column-gap:var(--wp--preset--spacing--60)"><!-- wp:designsetgo/section {"constrainWidth":false,"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"}},"border":{"radius":"16px"},"dimensions":{"minHeight":"350px"},"background":{"backgroundImage":{"url":"{{dsgo:placeholder-landscape}}","id":433,"source":"file","title":"pexels-kazze-14861070"},"backgroundSize":"cover"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center","verticalAlignment":"center"}} -->
<div class="wp-block-designsetgo-section alignfull dsgo-stack dsgo-no-width-constraint" style="border-radius:16px;min-height:350px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><div class="dsgo-stack__inner"><!-- wp:designsetgo/icon-button {"url":"#video-testimonial-modal","icon":"play","iconGap":"8px"} -->
<div class="wp-block-designsetgo-icon-button dsgo-justify dsgo-justify--left"><a class="dsgo-icon-button wp-block-button wp-block-button__link wp-element-button dsgo-icon-button--has-icon" style="gap:8px" href="#video-testimonial-modal" target="_self"><span class="dsgo-icon-button__icon dsgo-lazy-icon" data-icon-name="play"></span><span class="dsgo-icon-button__text">Play</span></a></div>
...
<figure class="wp-block-image size-thumbnail is-resized is-style-rounded"><img src="{{dsgo:placeholder-avatar}}" alt="Robert Chen" style="object-fit:cover;width:56px;height:56px"/></figure>
<!-- /wp:image -->
